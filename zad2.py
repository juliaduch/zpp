...
class Book:
    def __init__(self, library: Library, publication_date, author_name,
...
student3 = Student('Julia', [100, 200, 300])
student4 = Student('Agnieszka', [87, 19, 20])
student5 = Student('Wera', [11, 2, 54])
